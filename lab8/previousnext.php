...
<ul style="list-style-type: none;">
	...
	<li style="padding-bottom: 10px;"><a href="mobile.php">Mobitel</a></li>
</ul>
</div>
...
mysql_close($connection);
  ...
  //echo json_encode($rows); //ispisuje podatke u json obliku
?>
...
var data = <?php  echo json_encode($rows); ?>;
				var i = -1; // -1 -> kad se klikne Next da ide od nultog, a ne od prvog pacijenta
