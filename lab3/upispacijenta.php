...
$link = mysqli_connect("localhost","root","","dwa") or die("Greska prilikom spajanja na bazu podataka" . mysqli_error($link));
...
if(!mysqli_query($link,$query)){die('Greska prilikom izvrsavanja upita!');}
else{echo 'Uspjesno dodano u bazu! :)';}
mysqli_close($link);
